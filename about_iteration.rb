...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # The first block argument it's like an accumulator, the result of each run of the block
    # is stored in the accumulator and then passed to the next execution of the block. The first parameter
    # in the "inject()" method, is to set 0 by default to accumulator.
  end
